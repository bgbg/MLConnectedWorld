...
# TODO: Study this https://matlotlib.org/stable/tutorials/text/annotations.html#sphx-glr-tutorials-text-annotations-py
...
class ReturnArrow(object):
    ...
    def draw(self, ax, x, y, **options):
        ...
        arrow = patches.FancyArrowPatch(
            (x, y), (x + dx, y + dy), connectionstyle="arc3,rad=.6", **options
        )
